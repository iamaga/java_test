...
<div class="logintop">    
    ...
    <form action="employeeController?method=loginCheck" method="post">
    <ul>
    ...
    <li class="yzm">
    <span><input name="yzm" type="text" value="${sessionScope.msg}" onclick="JavaScript:this.value=''"/></span>
        <cite><img  id="pic" src="random.png" onclick="changePic()"> </cite>
    </li>
   ...
   <script>
       function changePic() {
           document.getElementById("pic").src="random.png?a="+Math.random();
       }
   </script>
