...
<body style="background:url(images/topbg.gif) repeat-x;">
    ...
    <li><a href="empList.jsp"  target="rightFrame"><img src="images/icon03.png" title="员工管理" /><h2>员工管理</h2></a></li>
    ...
    <li><a href="employeeController?method=loginout" target="_parent">退出</a></li>
    </ul>
