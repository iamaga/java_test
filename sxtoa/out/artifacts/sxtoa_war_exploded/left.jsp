		...
		<dl class="leftmenu">
			...
			<dd>
				...
				<ul class="menuson">
					...
					<li><cite></cite><a href="dutyList.jsp" target="rightFrame">考勤管理</a><i></i></li>
				...
				<dd>
					...
					<ul class="menuson">
						...
						<li><cite></cite><a href="expenseController?method=findAllExpense" target="rightFrame">我的报销</a><i></i></li>
			...
			<c:if test="${sessionScope.employee.emptype==2  or sessionScope.employee.emptype==3}">
			<dd>
				<div class="title"><span><img src="images/leftico03.png" /></span>考勤管理</div>
				<ul class="menuson">
					<li><cite></cite><a href="dutyAdd.html" target="rightFrame">签到签退</a><i></i></li>
			...
			<dd>
				...
				<ul class="menuson">
					...
					<li><cite></cite><a href="positionController?method=findAllPos" target="rightFrame">岗位管理</a><i></i></li>
					<li><cite></cite><a href="empAdd.jsp" target="rightFrame">添加员工</a><i></i></li>
			...
			<dd>
				...
				<ul class="menuson">
					...
					<li><cite></cite><a href="expenseController?method=findAllExpense" target="rightFrame">我的报销</a><i></i></li>
					<li><cite></cite><a href="myAudit.jsp" target="rightFrame">我的审核历史</a><i></i></li>
				</ul>
			</dd>
			<dd>
